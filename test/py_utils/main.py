...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--script", help="YAML file with the test folder and files")
    #parser.add_argument("-i", "--input", help="Input folder with the test files")
    parser.add_argument("-o", "--output", help="Destination folder to keep the processed files")
