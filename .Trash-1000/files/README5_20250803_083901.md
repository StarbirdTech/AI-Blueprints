...
# Overview
 ...
 This project shows how to do an image classification, specifically digits of handwritten images, using TensorFlow and the MNIST dataset of handwritten digits. The MNIST dataset consists of a collection of handwritten digits from 0 to 9. 
